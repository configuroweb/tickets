...
<div class="callout">
	...
	<tr>
		...
		<th>
			...
			<hr>
			<span>Estado: <span class="badge <?php echo $status_badge ?>"><?php echo $status ?></span></span>
...
<div class="card card-outline-primary col-md-7" id="card-comment">
	...
	<div class="card-footer">
			<form action="" id="leave_comment">
				...
				<div class="form-group">
					<button class="btn btn-primary btn-flat">Guardar Comentario</button>
				</div>
			</form>
	</div>
</div>
...
<script type="text/javascript">
	...
	function data_func(){
		$('.delete-comment').click(function(){
			_conf('Estás segur@ de eliminar este comentario','delete_data',[$(this).attr('data-id')]);
		})
	}
