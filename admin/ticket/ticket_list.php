		...
		<div class="card card-outline card-primary">
			<div class="card-header">
				...
				<div class="card-tools">
					<a class="btn btn-flat btn-primary btn-sm" type="button" href="<?php echo base_url ?>admin/?page=ticket&view=create_ticket"><span class="fa fa-plus"></span> Nuevo Ticket</a>
				</div>
			</div>
			<div class="card-body">
				<div class="container-fluid">
						...
						<table width="100%">
							...
							<tr>
								...
								<td width="70%">
									...
									<hr>
									<span><i>Estado</i>:</span> <span class="badge ticket-status"></span>
									<span class="float-right"><span><i>Fecha Creación</i>:</span> <span class="badge badge-light ticket-created"></span></span>
								</td>
									...
									<div class="btn-group">
					                  <button type="button" class="btn btn-default dropdown-toggle dropdown-icon" data-toggle="dropdown" aria-expanded="false">
					                    ...
					                    <div class="dropdown-menu" role="menu" style="">
				                    	  <a class="dropdown-item text-primary view_data" data-id="" href="javascript:void(0)"><span class="fa fa-eye"></span> Ver</a>
					                      <div class="dropdown-divider"></div>
					                      <a class="dropdown-item text-primary edit_data" data-id="" href="javascript:void(0)"><span class="fa fa-edit"></span> Editar</a>
					                      <div class="dropdown-divider"></div>
					                      <a class="dropdown-item text-danger delete_data" data-id="" href="javascript:void(0)"><span class="fa fa-trash text-fanger"></span> Eliminar</a>
					                   </div>
					                 </div>
								</td>
							</tr>
...
<script>
	function load_data($search = '<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : '' ?>'){
		...
		$.ajax({
			...
			error: err=>{
				console.log(err)
				alert_toast("A ocurrido este error",'error');
				end_loader();
			},
	...
	function data_func(){
		...
		$('.delete_data').click(function(){
			_conf('Estas seguro que quieres eliminar este registro?','delete_data',[$(this).attr('data-id')]);
		})
	...
	$(document).ready(function(){
		...
		$('#new_data').click(function(){
			uni_modal('<span class="fa fa-plus"></span> Crear una nueva categoría de servicio',_base_url_+'admin/services/manage_category.php')
		})
